...
class BahayaForm extends StatefulWidget {
  @override
  _BahayaFormState createState() => _BahayaFormState();
}

class _BahayaFormState extends State<BahayaForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldkey,
      appBar: AppBar(
        title: Text("Form Laporan Bahaya"),
      ),
      body: Form(
        key: _key,
        child: ListView(
              ...
              child: ElevatedButton(
                onPressed:() {
                  ...
                  if (form.validate() && _gambarFile != null){
                    ...
                    apiService.postBahaya(data).then(onSuccess).catchError(onError);                    
                  } else {
