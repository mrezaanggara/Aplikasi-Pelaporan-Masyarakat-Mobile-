...
class BahayaComment extends StatefulWidget {
  final int bahayaid;
  BahayaComment({@required this.bahayaid ,Key key }) : super(key: key);

  @override
  _BahayaCommentState createState() => _BahayaCommentState();
}

class _BahayaCommentState extends State<BahayaComment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: apiService.getBahayaCommentBy(widget.bahayaid),
                    ...
                    trailing: OutlinedButton(
                      onPressed: (){
                        ...
                        if (form.validate()){
                          ...
                          data.commentBahaya = widget.bahayaid.toString();
                          data.nama = nama;
                          print(data);
                          ...
                          apiService.postCommentBahaya(data).then(onSuccess).catchError(onError);
                        } else {
