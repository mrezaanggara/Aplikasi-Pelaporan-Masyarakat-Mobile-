...
class InfrastrukturForm extends StatefulWidget {
  @override
  _InfrastrukturFormState createState() => _InfrastrukturFormState();
}

class _InfrastrukturFormState extends State<InfrastrukturForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldkey,
      appBar: AppBar(
        title: Text("Form Laporan Infrastruktur"),
      ),
      body: Form(
        key: _key,
        child: ListView(
              ...
              child: ElevatedButton(
                onPressed:() {
                  ...
                  if (form.validate() && _gambarFile != null){
                    ...
                    apiService.postInfrastruktur(data).then(onSuccess).catchError(onError);                    
                  } else {
