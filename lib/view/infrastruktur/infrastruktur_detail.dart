...
import 'infrastruktur_comment.dart';

class DetailInfra extends StatefulWidget {
  final int infrastrukturid;
  DetailInfra({@required this.infrastrukturid, Key key }) : super(key: key);

  @override
  _DetailInfraState createState() => _DetailInfraState();
}

class _DetailInfraState extends State<DetailInfra> {
  ...
  void like() async {
    ...
    data.nik = nik;
    data.contentInfra = i.infrastrukturid;
    print(data);
    print("berhasil like");
    apiService2.postPrioritasInfra(data);
  }
  ...
  void dislike() async {
    ...
    apiService2.deletePrioritasInfra(data);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Detail laporan Infrastruktur"),
        leading: IconButton(
      ...
      body: Center(
        child: FutureBuilder<Infrastruktur>(
          // panggil function getUserBy(int id)
          future: apiService.getInfraBy(widget.infrastrukturid),
          builder: (context, snapshot) {
            ...
            // jika connection berhasil
              ...
              if(i.infrastrukturid != 0){
                var placeholder = Container(
                  height: 50,
                  decoration: BoxDecoration(
                    color: _setBoxColor(i.ket),
                    borderRadius: BorderRadius.circular(10)
                  ),
                  child: Center(child: Text("Laporan dalam Status '"+i.ket+"'",style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: _setTextColor(i.ket))),)
                );
                return ListView(
                  children: <Widget>[
                    Column(
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:
                                  "https://reportcases.000webhostapp.com/data/docs/laporan/infrastruktur/${i.gambar}.jpg",
                        ...
                        child: Column(
                            children: [
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: (){
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (BuildContext context) => InfraComment(infrastrukturid: i.infrastrukturid, key: ValueKey(i.infrastrukturid)))
                                        );
                                      }
                                    ),
                                    IconButton(
                              ...
                              Padding(
                                ...
                                child: FutureBuilder(
                                  future: apiService2.getPrioritasInfraCount(i.infrastrukturid),
                                  builder: (context,snapshot){
                                    if (snapshot.connectionState == ConnectionState.none &&
                                    snapshot.hasData == null){
                                          return LinearProgressIndicator();
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(i.judul,style: TextStyle(fontWeight: FontWeight.w400, fontSize: 18)),
                                    SizedBox(height: 15,),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        Text(" "+i.tglUpload,style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12)),
                                        Text("    "),
                                        Icon(Icons.info,size: 12,),
                                        Text(" "+i.ket,style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: _setTextColor(i.ket)))
                                      ],
                                    ),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      ...
                                      Text(" "+i.nama,style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12)),
                                      ]
                                    ),
                                    SizedBox(height: 10),
                                    Container(
                                      ...
                                      child: i.estimasi == "-" ? placeholder : Center(child: Text(" "+i.estimasi,style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Color(0xFF0f6848))),)
                                    )
                                  ],
                                ),
                              ),
                              ...
                              ListTile(
                                ...
                                subtitle: Text(i.deskripsi[0].toUpperCase()+i.deskripsi.substring(1),style: TextStyle(fontSize: 15)),
                              ),
                              SizedBox(height: 5),
                              ListTile(
                                title: const Text('Lokasi', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15)),
                                subtitle: Text(i.alamat, style: TextStyle(fontSize: 15)),
                              ),
                              SizedBox(height: 10),
                              Container(
                                padding: const EdgeInsets.fromLTRB(16,0,16,0),
