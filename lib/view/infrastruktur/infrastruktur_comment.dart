...
class InfraComment extends StatefulWidget {
  final int infrastrukturid;
  InfraComment({@required this.infrastrukturid ,Key key }) : super(key: key);

  @override
  _InfraCommentState createState() => _InfraCommentState();
}

class _InfraCommentState extends State<InfraComment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: apiService.getInfraCommentBy(widget.infrastrukturid),
                    ...
                    trailing: OutlinedButton(
                      onPressed: (){
                        ...
                        if (form.validate()){
                          ...
                          data.commentInfra = widget.infrastrukturid.toString();
                          data.nama = nama;
                          print(data);
                          ...
                          apiService.postCommentInfra(data).then(onSuccess).catchError(onError);
                        } else {
